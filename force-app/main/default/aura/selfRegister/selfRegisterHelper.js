    ...
    handleSelfRegister: function (component, event, helpler) {
     ...
     console.log('secondPosition====>>>',arr[1]);
        ...
        action.setParams({firstname:firstname,lastname:lastname,email:email,
                password:password, confirmPassword:confirmPassword, accountId:accountId, regConfirmUrl:regConfirmUrl, extraFields:extraFields, startUrl:startUrl, includePassword:includePassword,language:arr[1]});
